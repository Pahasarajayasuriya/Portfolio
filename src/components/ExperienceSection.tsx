...
const experiences = [
  {
    ...
    organization: 'Cloud Eight Technologies',
    period: 'Internship',
    description: 'Contributed to real-world software development projects, gaining hands-on experience in building scalable application features and team collaboration.',
    highlights: [
      'ALDO: Management system for golf clubs in Australia',
      'LEOS: Budget-friendly ride-hailing platform',
...
const education = [
  {
    ...
    highlights: [
      'Final-year research on microservices architecture',
            ...
            <div className="space-y-6">
              {experiences.map((exp) => (
                ...
                >
                  ...
                  <div className="bg-card p-6 rounded-2xl card-elevated">
          ...
          <div>
            ...
            <div className="space-y-6">
              {education.map((edu) => (
                <div
                  key={edu.title}
                  className="relative pl-8 border-l-2 border-accent/30 pb-8 last:pb-0"
                >
                  ...
                  <div className="bg-card p-6 rounded-2xl card-elevated">
                    ...
                    <p className="text-accent font-medium mb-3">{edu.organization}</p>
