        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute w-80 h-80 md:w-[28rem] md:h-[28rem] -top-8 rounded-full border-4 border-transparent animate-spin-slow bg-gradient-to-tr from-primary/30 via-accent/30 to-primary/10 blur-[2px]" style={{ zIndex: 0 }} />
              {/* Profile image container */}
              <div className="relative w-80 h-80 md:w-[28rem] md:h-[28rem] rounded-full overflow-hidden border-4 border-background -top-8">
                <img
                  src={profileImage}
              ...
              {/* Floating badges */}
              <div className="absolute -right-16 top-1/4 bg-card px-4 py-2 rounded-xl card-elevated animate-float">
                <span className="text-sm font-semibold">🚀 Problem Solver</span>
              </div>
              <div className="absolute -left-6 bottom-1/4 bg-card px-4 py-2 rounded-xl card-elevated animate-float" style={{ animationDelay: '1s' }}>
